...
void constrictor_mission_brief (void)
{
	...
	gfx_draw_colour_line (0, 36/2, 511/2, 36/2, GFX_COL_WHITE);

	gfx_display_pretty_text (12, 40, 300, 384, mission1_brief_a);
	...
	gfx_display_centre_text (340, "Press space to continue.", 140, GFX_COL_GOLD);

	do
	{
		gfx_clear_area (344/2, 38/2, (508-344)/2, (180-38)/2);
		update_universe ();
	...
	gfx_display_pretty_text (12, 40, 300, 384,
...
void thargoid_mission_second_brief (void)
{
	...
	gfx_draw_sprite (IMG_BLAKE, 352/2, 46/2);
	...
	gfx_display_pretty_text (16, 50, 300, 384, mission2_brief_c);
